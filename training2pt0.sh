...
python experiment.py --epochs 15 --batch_size 16 --D 300 --val_size 80870 --data_path "/home/s1834310/Dissertation/Data/QuoraDuplicateQuestions/" --output_filename "/home/s1834310/Dissertation/Models/quora_bert_SIF" --use_gpu 'True' --gpu_id '0' --train_dataset_name "quora_train_bert_SIF" --val_dataset_name "quora_val_bert_SIF" --seed 100 --dataset_class 'SIFDataset' --network 'HighwayReluNet' #--max_tokens 25
